...
class AlertsControllerTest < ActionController::TestCase
  ...
  test "should create alert" do
    assert_difference('Alert.count') do
      post :create, alert: { caregiver: @alert.caregiver, name: @alert.name, person: @alert.person, phone_number: @alert.phone_number }
    end
  ...
  test "should update alert" do
    patch :update, id: @alert, alert: { caregiver: @alert.caregiver, name: @alert.name, person: @alert.person, phone_number: @alert.phone_number }
    assert_redirected_to alert_path(assigns(:alert))
  end
