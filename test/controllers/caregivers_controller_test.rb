...
class CaregiversControllerTest < ActionController::TestCase
  ...
  test "should create caregiver" do
    assert_difference('Caregiver.count') do
      post :create, caregiver: { email: @caregiver.email, name: @caregiver.name, phone_number: @caregiver.phone_number }
    end
  ...
  test "should update caregiver" do
    patch :update, id: @caregiver, caregiver: { email: @caregiver.email, name: @caregiver.name, phone_number: @caregiver.phone_number }
    assert_redirected_to caregiver_path(assigns(:caregiver))
  end
